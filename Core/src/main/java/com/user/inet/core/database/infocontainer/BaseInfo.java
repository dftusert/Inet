package com.user.inet.core.database.infocontainer;
...
public class BaseInfo {
    ...
    public String toString() {
        return profile.toString() + " publicationsCount: " + publicationsCount + ", subscribersCount: " + subscribersCount + ", subscriptionsCount: " + subscriptionsCount;
    }
}